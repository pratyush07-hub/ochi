...
function Hooter() {
  return (
    <div className="w-full flex h-screen bg-[#F1F1F1] p-12">
        ...
        <div className="w-1/2">
        <h1 className="h-full tracking-ultra-tighter uppercase text-[6vw] leading-[7vw] font-bold font-['Founders Grotesk']">presentations</h1>
        <div className="dets font-['Neue_Montreal'] -mt-80">
            <h3>L:</h3>
            <a className="block text-xl underline" href="#">202-1965 W 4th Ave</a>
            <a className="block text-xl underline" href="#">Vancouver, Canada</a>
            <a className="block text-xl underline" href="#">30 Chukarina St</a>
            <a className="block text-xl underline" href="#">Lviv, Ukraine</a>
        </div>
        <div className="dets font-['Neue_Montreal'] py-5 -mt-80">
            <h3>S:</h3>
            <a className="block text-xl underline" href="#">Instagram</a>
            <a className="block text-xl underline" href="#">Behance</a>
            <a className="block text-xl underline" href="#">Linkedin</a>
            <a className="block text-xl underline" href="#">Facebook</a>
        </div>
        <div className="mt-80 font-light">&copy; ochi design 2024. <a href="#">Legal Terms</a></div>
        </div>
